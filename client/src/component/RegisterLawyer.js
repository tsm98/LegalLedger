...
class Register extends Component {
  async registerLawyer(name,bar_id, phone, email, address, pubkey, p) {
    const { account, court, GAS, GAS_PRICE } = p;
    console.log(court);
    await court.methods
      .registerLawyer(name,bar_id, phone, email, address, pubkey)
