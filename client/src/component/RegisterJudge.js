...
class Register extends Component {
  async registerJudge(name, bar_id, phone, email, address, pubkey, p) {
    const { account, court, GAS, GAS_PRICE } = p;
    console.log(court);
    await court.methods
      .registerJudge(name, bar_id, phone, email, address, pubkey)
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        this.registerJudge(name, bar_id, phone, email, address, pubk, p);
